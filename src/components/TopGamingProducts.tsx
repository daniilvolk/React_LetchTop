    ...
    <div>
      <section id="top-gaming-products" className="top-gaming-products">
        <div className="top-gaming-products__content">
          ...
          <div className="top-gaming-products__features">
            <div className="feature">
              <img src="/icon1.png" alt="Featured Products" className="feature__icon" />
            ...
            <div className="feature">
              <img src="/icon2.png" alt="Why Choose Us" className="feature__icon" />
        ...
        <div className="top-gaming-products__image">
          <img src="/gaming-setup.png" alt="Gaming Setup" />
        </div>
      </section>
      ...
      <section id="why-choose" className="why-choose">
        <div className="why-choose__content">
          ...
          <div className="why-choose__features">
            <div className="feature">
              <img src="/icon3.png" alt="Exceptional Support" className="feature__icon" />
            ...
            <div className="feature">
              <img src="/icon4.png" alt="Industry Warranties" className="feature__icon" />
        ...
        <div className="why-choose__image">
          <img src="/quality-setup.png" alt="Quality Setup" />
        </div>
      </section>
    </div>
  );
